...
class AnimeSeeder extends Seeder
{
    ...
    public function run()
    {
         DB::table('animes')->insert([
            ...
            [
                'title' => '七つの大罪',
                'Hiragana_title' => 'ななつのたいざい',
                'Latin_alphabet_title' => 'nanatunotaizai',
                'english_title' => 'The Seven Deadly Sins',
                'image' => '1702675741.jpg',
                'first_broadcast_start_date' => '2014/10/05',
                'second_broadcast_start_date' => '2018/01/06',
                'third_broadcast_start_date' => '2019/10/09',
                'fourth_broadcast_start_date' => '2021/01/06',
                'first_movie' => '七つの大罪 天空の囚われ人',
                'second_movie' => '七つの大罪 光に囚われし者たち',
                'third_movie' => null,
                'fourth_movie' => null,
                'synopsis' => "人と人ならざるものの世界が分かれていなかった時代。\n
                絶大な魔力を有し、人々に敬われ、時に恐れられる存在『聖騎士』に守られた『リオネス王国』。\n
                王国の王女『エリザベス』はたった一人国を離れ、ある者たちを探していた。\n
                それは全聖騎士を敵に回した罪人たちが所属する、世界最強の騎士団『七つの大罪』だった。\n
                そんな時、居酒屋を営むメリオダスと出会い、『七つの大罪』を探していることを話すと、メリオダスは自分が団長だと告白。\n
                そして、2人は残りのメンバーを探す旅に出るのであった。",
                'original_id' => 1
            ],
            [
                'title' => '進撃の巨人',
                'Hiragana_title' => 'しんげきのきょじん',
                'Latin_alphabet_title' => 'singekinokyojinn',
                'english_title' => 'Attack on Titan',
                'image' => '1702676001.jpg',
                'first_broadcast_start_date' => '2013/04/07',
                'second_broadcast_start_date' => '2017/04/01',
                'third_broadcast_start_date' => '2018/07/23',
                'fourth_broadcast_start_date' => '2020/12/07',
                'first_movie' => null,
                'second_movie' => null,
                'third_movie' => null,
                'fourth_movie' => null,
                'synopsis' => "人を食らう、知性も意志も持たない巨大な生物『巨人』。\n
				人類は天敵である『巨人』から身を守るため、巨大な3つの壁を築き、100年の平和を手にしていた。\n
				『壁が壊されるわけない』と、皆そう思っていた。しかし、突如として50mをも超える謎の『超大型巨人』が出現。\n
				壁は破壊され、無数の巨人が侵入。人類の平和は、壁と共に崩れてしまう。\n
				壁内に住む少年『エレン』は、怒りを爆発させ『駆逐してやる。この世から一匹残らず。』と、\n
			    巨人への復讐を誓うのであった。",
                'original_id' => 1
            ]
