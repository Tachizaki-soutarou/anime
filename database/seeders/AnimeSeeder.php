    ...
    public function run()
    {
         DB::table('animes')->insert([
            ...
            [
                ...
                'synopsis' => "西暦2022年、世界初のフルダイブ型VRゲーム『ソードアート・オンライン（SAO）』が正式リリースされ、約1万人のプレイヤーで賑わっていた。\nそんな中、突如ゲームからログアウトボタンが消失していることに気付く。開発者である『茅場晶彦』の手によりSAOは、\nアインクラッドの最上層階到達というSAOがクリアされるまでログアウト不可、ゲームオーバーが現実世界の死という恐ろしいデスゲームへと変貌してしまう。\n多くのプレイヤーはこの事実に恐れるが、『キリト』は恐れながらも、この世界で最強ソロプレイヤーとして生き抜くために抗い続ける。",
                'original_id' => 2,
                'category_id' => 3,
            ]
        ]);
